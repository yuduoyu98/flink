 ...
 *
 * <p>The serialized string representation is {@code RAW('c', 's')} where {@code c} is the
 * originating class and {@code s} is the serialized {@link TypeSerializerSnapshot} in Base64
 * encoding.
 *
