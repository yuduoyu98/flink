...
public class CompositeTypeSerializerSnapshotTest {
    ...
    public static class TestCompositeTypeSerializerSnapshot
        ...
        @Override
        protected TestCompositeTypeSerializer createOuterSerializerWithNestedSerializers(
                TypeSerializer<?>[] nestedSerializers) {
        ...
        protected TypeSerializer<?>[] getNestedSerializers(
                TestCompositeTypeSerializer outerSerializer) {
    ...
    /**
     * Used as nested serializers in the test composite serializer. A nested serializer can be
     * configured with a {@link TargetCompatibility}, which indicates what the result of the schema
     * compatibility check should be when a new instance of it is being checked for compatibility.
     */
    ...
    /**
     * A variant of the {@link NestedSerializer} used only when creating a reconfigured instance of
     * the serializer. This is used in tests as a tag to identify that the correct serializer
    ...
    /**
     * A variant of the {@link NestedSerializer} used only when creating a restored instance of the
     * serializer. This is used in tests as a tag to identify that the correct serializer instances
     * are being used.
     */
