 ...
 * have one input (such as {@link org.apache.flink.api.common.functions.RichMapFunction} or {@link
...
public abstract class SingleInputUdfOperator<IN, OUT, O extends SingleInputUdfOperator<IN, OUT, O>>
    ...
    /**
     * Creates a new operators with the given data set as input. The given result type describes the
     * data type of the elements in the data set produced by the operator.
     *
    ...
    protected SingleInputSemanticProperties extractSemanticAnnotations(Class<?> udfClass) {
        ...
        return SemanticPropUtil.getSemanticPropsSingle(
                annotations, getInputType(), getResultType());
    }
